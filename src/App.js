...
const API_KEY = '589737d0c2mshd5724a7cf3ed992p12857bjsn20e22a13855b';
...
function App() {
  ...
  return (
    <div className="mainBody" style={{ backgroundColor: isDarkMode ? 'black' : 'white' }}>
      <div className='header' style={{ color: !isDarkMode ? 'white' : 'black' }}>
        <div className="titleName">bookie</div>
        <button className="button1" style={{ color: !isDarkMode ? 'white' : 'black' }} onClick={toggleColors}>{buttonText}</button>
        <button className="button1" style={{ color: !isDarkMode ? 'white' : 'black' }} onClick={showfavourites}>Show favourites</button>
        <div className="menuBarMain">
          <input className="menuBar" type="search" style={{ color: !isDarkMode ? 'white' : 'black' }} onChange={handleNameSearch} value={title} placeholder="Search by Name" />
          <input className="menuBar" type="search" style={{ color: !isDarkMode ? 'white' : 'black' }} onChange={handleAuthorSearch} value={author} placeholder="Search by Author" />
        </div>
      </div>
      ...
      <div className="footer">
        <button className="button2" type="button" style={{ color: !isDarkMode ? 'white' : 'black' }} onClick={handlePreviousPage} disabled={page === 1}>PREVIOUS</button>
        <button className="button2" type="button" style={{ color: !isDarkMode ? 'white' : 'black' }} onClick={handleNextPage}>NEXT</button>
      </div>
    </div>
  );
}
